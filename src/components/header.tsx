...
export default function AppHeader({ collapsed, setCollapsed, pageTitle = "Dashboard" }: HeaderProps) {
  ...
  const notificationMenu = (
    ...
    >
      ...
      <div style={{ maxHeight: "360px", overflow: "auto", padding: "8px 0" }}>
        {notificationItems.map((item) => (
          <div
            ...
            style={{
              ...
              background: item.read ? "transparent" : isDark ? "rgba(16, 185, 129, 0.05)" : "rgba(16, 185, 129, 0.03)",
              cursor: "pointer",
  ...
  return (
    ...
    >
      <div style={{ display: "flex", alignItems: "center" }}>
        ...
        {searchVisible && (
          <div style={{ padding: "0 16px", flex: 1, maxWidth: "500px" }}>
            <Input
              placeholder="Search..."
              prefix={<SearchOutlined style={{ color: isDark ? "rgba(255, 255, 255, 0.5)" : "rgba(0, 0, 0, 0.5)" }} />}
              style={{
                width: "100%",
                borderRadius: "8px",
                background: isDark ? "rgba(255, 255, 255, 0.05)" : "rgba(0, 0, 0, 0.03)",
      ...
      <div style={{ display: "flex", alignItems: "center", padding: "0 16px" }}>
        ...
        <div style={{ position: "relative" }}>
          <Badge count={notificationItems.filter((item) => !item.read).length} overflowCount={9}>
            <Button
              type="text"
              icon={<BellOutlined />}
