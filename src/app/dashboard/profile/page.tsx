"use client"
import { Card, Avatar, Tabs, Form, Input, Button, Row, Col, Divider, List, Tag, Upload, message } from "antd"
import { UserOutlined, MailOutlined, LockOutlined, PhoneOutlined, HomeOutlined, EditOutlined } from "@ant-design/icons"
          ...
          >
            <div style={{ textAlign: "center" }}>
              ...
              <Upload
                ...
                beforeUpload={() => {
                  message.info("Profile picture upload functionality would be implemented here")
                  return false
                }}
              >
              ...
              <h2 style={{ marginTop: 16, marginBottom: 4, color: isDark ? "#fff" : "#000" }}>Admin User</h2>
              <p
                style={{
              ...
              <Row gutter={[8, 16]}>
                <Col span={24}>
                  <p style={{ color: isDark ? "rgba(255, 255, 255, 0.85)" : "rgba(0, 0, 0, 0.85)" }}>
              ...
              <Divider style={{ borderColor: isDark ? "#303030" : "#f0f0f0" }} />
              <div>
                <h4 style={{ color: isDark ? "#fff" : "#000" }}>Skills</h4>
